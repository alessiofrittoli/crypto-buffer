# Contributing to Crypto Buffer 🚌

We’re excited that you’re interested in contributing to Crypto Buffer! This guide will help you get started.
...
- Search Existing Issues: Check the [Issues](https://github.com/alessiofrittoli/crypto-buffer/issues) tab to see if your concern has already been addressed.
...
- Go to the [repository page](https://github.com/alessiofrittoli/crypto-buffer).
- Click the Fork button.
- Clone your fork to your local machine:

```bash
git clone https://github.com/your-username/crypto-buffer.git
```
...
Thank you for helping improve Crypto Buffer! 🎉